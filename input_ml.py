...
ex: "/Users/Youssoufj/Environments/GoogleCloud/data" 
...
for input_file in [f for f in os.listdir(data_dir+"/001") if not f.startswith('.')]:
    ...
    detect_hand_writtent_text(gcs_source_uri, gcs_destination_uri, os.path.abspath(data_dir)+"/input/"+input_file)
